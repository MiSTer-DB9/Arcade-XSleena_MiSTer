...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-XSleena_MiSTer.git"
CORE_NAME=(Arcade-XSleena)
...
UPSTREAM_CORE_NAME=(Arcade-XSleena)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-XSleena.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-XSleena.rbf)
